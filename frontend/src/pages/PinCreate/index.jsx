...
function UploadCard(){
    return(
        <div className="px-4 outline-dashed outline-gray-400 h-full py-16">
            <div className="flex flex-col items-center">
                <AiOutlineCloudUpload size={30}/>
                <p>Click to Upload</p>
            </div>
            <p className="text-gray-400 mt-24 text-justify text-sm">
        ...
        <section className="min-h-screen">
            <div className="flex flex-col md:flex-row max-w-[900px] md:mt-12 overflow-hidden bg-white mx-auto px-4 py-4">
                <div className="w-full md:w-[45%]">
                    <div className="h-[400px] bg-[#F0F0F0] p-4">
                        <UploadCard/>
                    </div>
                </div>    
